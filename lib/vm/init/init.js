...
var scaffold = glush.Scaffold({
  ...
  content: {
    intro: glush.colors.bold(" Welcome to the Hence.io Manhine Generator. ") + "Your vm generation is about to begin.",
    done: glush.colors.bold(" Thank you for using the Hence.io Manchine Generator!\n") +
    " Review the possible machine commands available to you on the project documentation, or type '" +
    glush.colors.bold('hence help machine') + "' at any time."
  },
  inquirer: {
