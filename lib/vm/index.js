...
/**
 * Bring up a VM, optionally provide name, defaults to machine in current dir
 */
program
  .command('up [name]')
...
/**
 * Restart up a VM, optionally provide name, defaults to machine in current dir
 */
program
  .command('restart')
  .description('Bring up the hence vm')
...
/**
 * Stop up a VM, optionally provide name, defaults to machine in current dir
 */
program
  .command('stop')
  .description('Bring up the hence vm')
...
/**
 * Connect up a VM dashboard, optionally provide name, defaults to machine in current dir
 */
program
  .command('connect')
...
/**
 * SSH into a VM, optionally provide name, defaults to machine in current dir
 */
program
  .command('ssh')
  .description('Bring up the hence vm')
...
/**
 * Destroy a VM, optionally provide name, defaults to machine in current dir
 */
program
